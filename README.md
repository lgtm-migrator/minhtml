...
[minhtml](https://minhtml.js.org), short for "minify html" is a highly **configurable**, **well-tested**, **JavaScript-based** HTML minifier. It also supports Mustache templates.
